        ...
        <div className="card">
          {status === 'loading' && (
            <div className="flex flex-col items-center gap-4 py-8">
              ...
              <p className="text-surface-muted text-sm">Verificando link...</p>
            </div>
          )}
            ...
            <div className="flex flex-col items-center gap-4 py-6 text-center">
              ...
              <div>
                ...
                <p className="text-surface-muted text-sm leading-relaxed">
                  Este link de redefinição de senha não é mais válido (expirou após 1 hora ou já foi utilizado).
                </p>
              </div>
              <button className="btn-secondary btn-sm mt-2" onClick={() => router.push('/forgot-password')}>
                Solicitar novo link
              </button>
            </div>
          )}
          ...
          {status === 'success' && (
            <div className="flex flex-col items-center gap-4 py-6 text-center">
              ...
              <div>
                <h2 className="text-lg font-semibold text-white mb-2">Senha redefinida com sucesso!</h2>
          ...
          {status === 'valid' && (
            <>
              <div className="mb-6">
                <h2 className="text-xl font-semibold text-white mb-1">Redefina sua senha</h2>
                <p className="text-surface-muted text-sm">
                  Olá, <span className="text-brand-300 font-medium">{userName}</span>! Crie uma nova senha de acesso.
                </p>
